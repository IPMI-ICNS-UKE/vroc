...
if [ "$SESSIONEXISTS" = "" ]; then
  ...
  tmux send-keys -t 'VROC 1' 'conda activate vroc' C-m 'python sample_parameter_space.py /home/administrator/data/learn2reg/NLST /home/administrator/data/learn2reg/results/param_sampling.sqlite --n-worker 5 --i-worker 0 --device cuda:1' C-m

  tmux new-window -t $SESSION:2 -n 'VROC 2'
  tmux send-keys -t 'VROC 2' 'conda activate vroc' C-m 'python sample_parameter_space.py /home/administrator/data/learn2reg/NLST /home/administrator/data/learn2reg/results/param_sampling.sqlite --n-worker 5 --i-worker 1 --device cuda:2' C-m
